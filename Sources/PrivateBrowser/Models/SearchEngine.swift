...
struct BrowserSettingsStore {
    ...
    static var blockAds: Bool {
        UserDefaults.standard.object(forKey: SettingsKey.blockAds) == nil
            ? true
            : UserDefaults.standard.bool(forKey: SettingsKey.blockAds)
    }

    static var autoClearOnBackground: Bool {
        UserDefaults.standard.bool(forKey: SettingsKey.autoClearOnBackground)
    }
}
