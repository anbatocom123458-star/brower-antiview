...
struct AboutView: View {
    ...
    private let features: [(icon: String, title: String, detail: String)] = [
        ...
        ("fingerprint", "Chống dấu vân tay trình duyệt", "Giả lập Canvas & WebGL fingerprint, giảm khả năng bị nhận diện qua nhiều trang."),
        ...
        ("flame.fill", "Xoá dữ liệu một chạm", "Dọn sạch toàn bộ cookie, cache, localStorage chỉ với một nút bấm."),
    ]
